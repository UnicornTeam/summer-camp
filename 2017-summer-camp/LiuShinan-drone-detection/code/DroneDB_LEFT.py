...
# Title: Dronedb Left
# Generated: Tue Aug 22 19:48:08 2017
##################################################
...
class DroneDB_LEFT(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Dronedb Left")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Dronedb Left")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "DroneDB_LEFT")
        ...
        self.blocks_file_sink_0_0_1_0 = blocks.file_sink(gr.sizeof_char*1, "/home/summit/DroneIndicator/rightGFSK_LEFT.dat", True)
        self.blocks_file_sink_0_0_1_0.set_unbuffered(False)
        self.blocks_file_sink_0_0_1 = blocks.file_sink(gr.sizeof_char*1, "/home/summit/DroneIndicator/leftGFSK_LEFT.dat", True)
        self.blocks_file_sink_0_0_1.set_unbuffered(False)
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_float*1, "/home/summit/DroneIndicator/rightFRMS_LEFT.dat", True)
        self.blocks_file_sink_0_0_0.set_unbuffered(False)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_float*1, "/home/summit/DroneIndicator/leftFRMS_LEFT.dat", True)
...
def main(top_block_cls=DroneDB_LEFT, options=None):
